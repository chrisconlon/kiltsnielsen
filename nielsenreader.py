...
class PanelReader(object):
    ...
    def read_year(self, year, keep_dmas = None, drop_dmas = None,
        ...
        self.df_trips = self.df_trips.append(df_trips.copy(), ignore_index = True)
        self.df_purchases = self.df_purchases.append(df_purchases.copy(), ignore_index = True)
        self.df_panelists = self.df_panelists.append(df_panelists.copy(), ignore_index = True)
